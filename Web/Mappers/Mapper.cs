...
namespace Web.Mappers
{
    public static class Mapper
    {
        public static ArticleModel EntryToArticle(dynamic entryItem)
        {
            ...
            model.BuyBookUrl = GetFieldValue(entryItem, "BuyBookUrl");
            model.BookImageUrl = GetFieldValue(entryItem, "BookImageUrl");
        ...
        public static ArticleView ArticleToView(ArticleModel model)
        {
            ...
            view.BuyBookUrl = model.BuyBookUrl;
            view.BookImageUrl = model.BookImageUrl;
